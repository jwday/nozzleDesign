...
P_t_init = 93  # Max Total Pressure (psia)
P_amb = 1  # Ambient Pressure (psia)
...
# Nozzle geometry
d_star = 0.2  # Throat diameter (mm)
expansion_ratio = 5  # 1.8048 for ideal expansion at 114.7 psi supply, 2.2447 for 164.7, 1.3225 for 0.2mm and 64.7 psi, 1.1235 for 0.3 and 44.7 psi
# # PSI  ----- Exp. Ratio
# # 114.7 --- 1.8048
# # 65 --- 1.3225
# # 
...
ax3.plot(time_offset, [x*1000 for x in cumulative_impulse], color='#2ca02c', label='Total Impulse (mN-s)')
